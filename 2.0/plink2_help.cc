...
"                     ['sparse-matrix'] ['cols='<col set descriptor>]\n"
...
"    * The 'sparse-matrix' modifier indicates that the input file is in Matrix\n"
"      Market sparse matrix format (as generated by R's Matrix::writeMM()).\n"
"      When this modifier is used, the input file should be a sparse matrix\n"
"      where rows represent SNPs and columns represent scores. Use\n"
"      --score-snp-map <file> to provide a mapping file (row index -> variant_id\n"
"      allele), and --score-score-map <file> to provide a mapping file (column\n"
"      index -> score_name). If mapping files are not provided, mappings may be\n"
"      parsed from Matrix Market comment lines, or default names will be used.\n"
...
"                           indexes and/or ranges of them.\n"
    ...
    HelpPrint("score-snp-map\0score\0", &help_ctrl, 0,
"  --score-snp-map <file> : When using --score with 'sparse-matrix', this\n"
"                           provides a mapping file from row indices (1-based) to\n"
"                           variant IDs and alleles. Format: one line per SNP,\n"
"                           '<row_index> <variant_id> <allele>'. If not provided,\n"
"                           mappings may be parsed from Matrix Market comment lines.\n"
               );
    HelpPrint("score-score-map\0score\0", &help_ctrl, 0,
"  --score-score-map <file> : When using --score with 'sparse-matrix', this\n"
"                             provides a mapping file from column indices (1-based)\n"
"                             to score names. Format: one line per score,\n"
"                             '<col_index> <score_name>'. If not provided, mappings\n"
"                             may be parsed from Matrix Market comment lines, or\n"
"                             default names (SCORE1, SCORE2, etc.) will be used.\n"
               );
